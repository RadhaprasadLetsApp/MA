 ...
 */
public class RowAdapterPermit extends RecyclerView.Adapter<RowAdapterPermit.ViewHolder>
{
    ...
    public RowAdapterPermit(ArrayList<ListItem> mContent, int rowLayout, Activity context)
    {
