 ...
 */
public class RowAdapterZone extends RecyclerView.Adapter<RowAdapterZone.ViewHolder>
{
    ...
    public RowAdapterZone(ArrayList<ListItem> mContent, int rowLayout, Activity context)
    {
