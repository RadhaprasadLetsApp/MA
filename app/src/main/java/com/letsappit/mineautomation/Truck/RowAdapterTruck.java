 ...
 */
public class RowAdapterTruck extends RecyclerView.Adapter<RowAdapterTruck.ViewHolder>
{
    ...
    public RowAdapterTruck(ArrayList<ListItem> mContent, int rowLayout, Activity context)
    {
